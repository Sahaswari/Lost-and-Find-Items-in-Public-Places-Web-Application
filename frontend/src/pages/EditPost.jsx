  ...
  return (
    ...
    <div className="px-6 md:px-[200px] mt-8">
      ...
      <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
        <input  onChange={(e)=>setTitle(e.target.value)} value={title} type="text" className="px-4 py-2 outline-none" placeholder="Enter post title"></input>
        ...
        <input onChange={(e)=>setContactNo(e.target.value)} value={contactNo} type="text" className="px-4 py-2 outline-none" placeholder="Enter contact Number"></input>
        <button onClick={handleUpdate}  className="bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4
        py-2 md:text-xl text-lg">Update</button>
      </form>
